        ...
        <Button
          ...
          onPress={() => {
            ...
            if (z > 0 && z < 201 && x % 100 == 0 && y % 100 == 0) {
              ...
              setErrorMessage(
                'Invalid input, end time should be later than start time',
              )
            } else if (!(z > 0 && z < 201)) {
              setErrorMessage(
                'Maximum allowed time is exceeded, you can only book a room up to 2 hours/day' +
                  '\n' +
                  start +
                  '\n' +
                  end,
              ...
              setErrorMessage(
                'A booking can only be started and ended at XX:00 or XX:30',
              )
            }
          }}
        />
