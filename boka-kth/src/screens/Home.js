  ...
  let renderRoom = ({ item }) => {
    ...
    return (
      <View style={AppStyles.rowContainer}>
        ...
        <TimeSlot
          text="08.00 - 09.00"
          disabled={roomAv[item.roomId - 301][0]}
          onPress={() => {
            getBookedHours()
            book(item.roomId, '08:00', '09:00', item.id, '0')
          }}
          style={[
            roomAv[item.roomId - 301][0]
        ...
        <TimeSlot
          text="09.00 - 10.00"
          disabled={roomAv[item.roomId - 301][1]}
          onPress={() => {
            getBookedHours()
            book(item.roomId, '09:00', '10:00', item.id, '1')
          }}
          style={[
            roomAv[item.roomId - 301][1]
              ? AppStyles.disabledBookingButton
              : AppStyles.bookingButton,
          ]}
        />
        <TimeSlot
          text="10.00 - 11.00"
          disabled={roomAv[item.roomId - 301][2]}
          onPress={() => {
            getBookedHours()
            book(item.roomId, '10:00', '11:00', item.id, '2')
          }}
          style={[
            roomAv[item.roomId - 301][2]
              ? AppStyles.disabledBookingButton
              : AppStyles.bookingButton,
          ]}
        />
        <TimeSlot
          text="12.00 - 13.00"
          disabled={roomAv[item.roomId - 301][3]}
          onPress={() => {
            getBookedHours()
            book(item.roomId, '11:00', '12:00', item.id, '3')
          }}
          style={[
            roomAv[item.roomId - 301][3]
              ? AppStyles.disabledBookingButton
              : AppStyles.bookingButton,
          ]}
        />
        <TimeSlot
          text="13.00 - 14.00"
          disabled={roomAv[item.roomId - 301][4]}
          onPress={() => {
            getBookedHours()
            book(item.roomId, '12:00', '13:00', item.id, '4')
          }}
          style={[
            roomAv[item.roomId - 301][4]
              ? AppStyles.disabledBookingButton
              : AppStyles.bookingButton,
          ]}
        />
        <TimeSlot
          text="14.00 - 15.00"
          disabled={roomAv[item.roomId - 301][5]}
          onPress={() => {
            getBookedHours()
            book(item.roomId, '13:00', '14:00', item.id, '5')
          }}
          style={[
            roomAv[item.roomId - 301][5]
              ? AppStyles.disabledBookingButton
              : AppStyles.bookingButton,
          ]}
        />
        <TimeSlot
          text="15.00 - 16.00"
          disabled={roomAv[item.roomId - 301][6]}
          onPress={() => {
            getBookedHours()
            book(item.roomId, '14:00', '15:00', item.id, '6')
          }}
          style={[
            roomAv[item.roomId - 301][6]
              ? AppStyles.disabledBookingButton
              : AppStyles.bookingButton,
          ]}
        />
        <TimeSlot
          text="16.00 - 17.00"
          disabled={roomAv[item.roomId - 301][7]}
          onPress={() => {
            getBookedHours()
            book(item.roomId, '15:00', '16:00', item.id, '7')
          }}
          style={[
            roomAv[item.roomId - 301][7]
              ? AppStyles.disabledBookingButton
              : AppStyles.bookingButton,
          ]}
        />
        <TimeSlot
          text="17.00 - 18.00"
          disabled={roomAv[item.roomId - 301][8]}
          onPress={() => {
            getBookedHours()
            book(item.roomId, '16:00', '17:00', item.id, '8')
          }}
          style={[
            roomAv[item.roomId - 301][8]
              ? AppStyles.disabledBookingButton
              : AppStyles.bookingButton,
          ]}
        />
